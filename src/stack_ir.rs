...
pub enum StackOp {
    ...
    //
    // Register-only: the l0/l1/l2 GPRs are the *sole* storage for hot
    // local slots. There is no memory mirror in locals[0..2]. To stay
    // coherent with fusion, any fused op whose slot arg is hot must use
    // a register-specialized variant rather than the generic
    // memory-based fused op (see the Fused*Ln* variants below).
    ...
    LocalSetL2,
    /// Peek top of stack into hot local register 0 (don't pop).
    LocalTeeL0,
    /// Peek top of stack into hot local register 1 (don't pop).
    LocalTeeL1,
    /// Peek top of stack into hot local register 2 (don't pop).
    LocalTeeL2,
    ...
    LocalTeeL0F, LocalTeeL1F, LocalTeeL2F,
...
impl fmt::Display for StackOp {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            StackOp::LocalTeeL0 => write!(f, "local.tee_l0"),
            StackOp::LocalTeeL1 => write!(f, "local.tee_l1"),
            StackOp::LocalTeeL2 => write!(f, "local.tee_l2"),
            ...
            StackOp::LocalTeeL0F => write!(f, "fw.local.tee_l0"),
            StackOp::LocalTeeL1F => write!(f, "fw.local.tee_l1"),
            StackOp::LocalTeeL2F => write!(f, "fw.local.tee_l2"),
