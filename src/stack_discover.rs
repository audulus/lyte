...
fn tag_of(op: &StackOp) -> OpTag {
    match op {
        ...
        StackOp::FAdd => OpTag::FAdd,
        StackOp::FSub => OpTag::FSub,
        StackOp::FMul => OpTag::FMul,
        StackOp::FDiv => OpTag::FDiv,
        StackOp::DAdd => OpTag::DAdd,
        StackOp::DSub => OpTag::DSub,
        StackOp::DMul => OpTag::DMul,
        StackOp::DDiv => OpTag::DDiv,
        StackOp::FNeg => OpTag::FNeg,
        ...
        StackOp::FEq => OpTag::FEq,
        StackOp::FNe => OpTag::FNe,
        StackOp::FLt => OpTag::FLt,
        StackOp::FLe => OpTag::FLe,
        StackOp::FGt => OpTag::FGt,
        StackOp::FGe => OpTag::FGe,
        ...
        StackOp::SinF32 => OpTag::SinF32,
        StackOp::CosF32 => OpTag::CosF32,
        StackOp::I32ToF32 => OpTag::I32ToF32,
        StackOp::F32ToI32 => OpTag::F32ToI32,
