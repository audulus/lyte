...
extern "C" {
    ...
    // Hot-local specialized handlers (generated by gen_fused_handlers.py)
    fn op_fused_get_l0f_get_fmul_f();
    fn op_fused_get_get_l1f_fmul_f();
    fn op_fused_get_l0_addimm_set_l0();
    fn op_fused_get_l1_addimm_set_l1();
    fn op_fused_get_l2_addimm_set_l2();
    fn op_fused_get_l1_set();
    fn op_fused_get_l0_get_ilt();
    fn op_fused_get_l1_get_ilt();
    fn op_fused_get_l0_get_l1_ilt();
    fn op_fused_get_l1f_fmul_f();
    fn op_fused_get_get_ilt_jiz_l0a();
    fn op_fused_get_get_ilt_jiz_l1a();
    fn op_fused_get_get_ilt_jiz_l2a();
    fn op_fused_addr_imm_get_store32_l1v();
    fn op_fused_addr_imm_get_store32_l2v();
    fn op_fused_addr_get_sload32_l0i();
    fn op_fused_addr_get_sload32_l1i();
    fn op_fused_tee_sstore32_l2n_l1i();
    fn op_fused_tee_sstore32_l0i();
    fn op_fused_tee_sstore32_l1i();
    fn op_fused_get_get_iadd_set_l2b_l1d();
    fn op_fused_get_get_iadd_set_l1a_l0d();
    fn op_fused_get_get_fadd_set_l0a_l0d();
    fn op_fused_local_array_load32_f_l2i();
    fn op_fused_local_array_store32_l1i();
    fn op_fused_local_array_store32_f_l0i();
    fn op_fused_addr_get_sload32_f_l0i();
    fn op_fused_addr_get_sload32_f_l1i();
    fn op_fused_tee_sstore32_f_l2n_l0i();
    fn op_fused_tee_sstore32_f_l0i();
    fn op_fused_tee_sstore32_f_l1i();
}

use crate::stack_hot_locals::{HOT_L0, HOT_L1, HOT_L2};

fn is_hot(s: u16) -> bool {
    s == HOT_L0 || s == HOT_L1 || s == HOT_L2
}
...
fn handler_for(op: &StackOp) -> *const () {
    match op {
        ...
        StackOp::FusedGetGetFAddSet(a, _, d) if *a == HOT_L0 && *d == HOT_L0
            => op_fused_get_get_fadd_set_l0a_l0d as *const (),
        ...
        StackOp::FusedGetGetIAddSet(a, b, d) if *b == HOT_L2 && *d == HOT_L1
            => op_fused_get_get_iadd_set_l2b_l1d as *const (),
        StackOp::FusedGetGetIAddSet(a, _, d) if *a == HOT_L1 && *d == HOT_L0
            => op_fused_get_get_iadd_set_l1a_l0d as *const (),
        ...
        StackOp::FusedLocalArrayStore32(_, i) if *i == HOT_L1
            => op_fused_local_array_store32_l1i as *const (),
        StackOp::FusedLocalArrayStore32(_, _) => op_fused_local_array_store32 as *const (),
        StackOp::FusedTeeSliceStore32(n, _, i) if *n == HOT_L2 && *i == HOT_L1
            => op_fused_tee_sstore32_l2n_l1i as *const (),
        StackOp::FusedTeeSliceStore32(_, _, i) if *i == HOT_L0
            => op_fused_tee_sstore32_l0i as *const (),
        StackOp::FusedTeeSliceStore32(_, _, i) if *i == HOT_L1
            => op_fused_tee_sstore32_l1i as *const (),
        StackOp::FusedTeeSliceStore32(_, _, _) => op_fused_tee_sstore32 as *const (),
        StackOp::FusedGetSet(a, _) if *a == HOT_L1
            => op_fused_get_l1_set as *const (),
        ...
        StackOp::FusedAddrImmGetStore32(_, _, v) if *v == HOT_L1
            => op_fused_addr_imm_get_store32_l1v as *const (),
        StackOp::FusedAddrImmGetStore32(_, _, v) if *v == HOT_L2
            => op_fused_addr_imm_get_store32_l2v as *const (),
        ...
        StackOp::FusedGetGetILt(a, b) if *a == HOT_L0 && *b == HOT_L1
            => op_fused_get_l0_get_l1_ilt as *const (),
        StackOp::FusedGetGetILt(a, _) if *a == HOT_L0
            => op_fused_get_l0_get_ilt as *const (),
        StackOp::FusedGetGetILt(a, _) if *a == HOT_L1
            => op_fused_get_l1_get_ilt as *const (),
        StackOp::FusedGetGetILt(_, _) => op_fused_get_get_ilt as *const (),
        StackOp::FusedAddrLoad32Off(_, _) => op_fused_addr_load32off as *const (),
        StackOp::FusedGetAddImmSet(s, _, d) if *s == HOT_L0 && *d == HOT_L0
            => op_fused_get_l0_addimm_set_l0 as *const (),
        StackOp::FusedGetAddImmSet(s, _, d) if *s == HOT_L1 && *d == HOT_L1
            => op_fused_get_l1_addimm_set_l1 as *const (),
        StackOp::FusedGetAddImmSet(s, _, d) if *s == HOT_L2 && *d == HOT_L2
            => op_fused_get_l2_addimm_set_l2 as *const (),
        StackOp::FusedGetAddImmSet(_, _, _) => op_fused_get_addimm_set as *const (),
        StackOp::FusedGetGetILtJumpIfZero(a, _, _) if *a == HOT_L0
            => op_fused_get_get_ilt_jiz_l0a as *const (),
        StackOp::FusedGetGetILtJumpIfZero(a, _, _) if *a == HOT_L1
            => op_fused_get_get_ilt_jiz_l1a as *const (),
        StackOp::FusedGetGetILtJumpIfZero(a, _, _) if *a == HOT_L2
            => op_fused_get_get_ilt_jiz_l2a as *const (),
        ...
        StackOp::FusedAddrGetSliceLoad32(_, i) if *i == HOT_L0
            => op_fused_addr_get_sload32_l0i as *const (),
        StackOp::FusedAddrGetSliceLoad32(_, i) if *i == HOT_L1
            => op_fused_addr_get_sload32_l1i as *const (),
        ...
        StackOp::FusedGetGetFMulF(a, _) if *a == HOT_L0
            => op_fused_get_l0f_get_fmul_f as *const (),
        StackOp::FusedGetGetFMulF(_, b) if *b == HOT_L1
            => op_fused_get_get_l1f_fmul_f as *const (),
        StackOp::FusedGetGetFMulF(_, _) => op_fused_get_get_fmul_f as *const (),
        StackOp::FusedGetFMulF(a) if *a == HOT_L1
            => op_fused_get_l1f_fmul_f as *const (),
        ...
        StackOp::FusedAddrGetSliceLoad32F(_, i) if *i == HOT_L0
            => op_fused_addr_get_sload32_f_l0i as *const (),
        StackOp::FusedAddrGetSliceLoad32F(_, i) if *i == HOT_L1
            => op_fused_addr_get_sload32_f_l1i as *const (),
        ...
        StackOp::FusedTeeSliceStore32F(n, _, i) if *n == HOT_L2 && *i == HOT_L0
            => op_fused_tee_sstore32_f_l2n_l0i as *const (),
        StackOp::FusedTeeSliceStore32F(_, _, i) if *i == HOT_L0
            => op_fused_tee_sstore32_f_l0i as *const (),
        StackOp::FusedTeeSliceStore32F(_, _, i) if *i == HOT_L1
            => op_fused_tee_sstore32_f_l1i as *const (),
        StackOp::FusedTeeSliceStore32F(_, _, _) => op_fused_tee_sstore32_f as *const (),
        StackOp::FusedLocalArrayLoad32F(_, i) if *i == HOT_L2
            => op_fused_local_array_load32_f_l2i as *const (),
        StackOp::FusedLocalArrayLoad32F(_, _) => op_fused_local_array_load32_f as *const (),
        StackOp::FusedLocalArrayStore32F(_, i) if *i == HOT_L0
            => op_fused_local_array_store32_f_l0i as *const (),
