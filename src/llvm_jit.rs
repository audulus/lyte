...
extern "C" fn llvm_lyte_sinf(x: f32) -> f32 { x.sin() }
extern "C" fn llvm_lyte_cosf(x: f32) -> f32 { x.cos() }
extern "C" fn llvm_lyte_tanf(x: f32) -> f32 { x.tan() }
extern "C" fn llvm_lyte_asinf(x: f32) -> f32 { x.asin() }
extern "C" fn llvm_lyte_acosf(x: f32) -> f32 { x.acos() }
extern "C" fn llvm_lyte_atanf(x: f32) -> f32 { x.atan() }
extern "C" fn llvm_lyte_sinhf(x: f32) -> f32 { x.sinh() }
extern "C" fn llvm_lyte_coshf(x: f32) -> f32 { x.cosh() }
extern "C" fn llvm_lyte_tanhf(x: f32) -> f32 { x.tanh() }
extern "C" fn llvm_lyte_asinhf(x: f32) -> f32 { x.asinh() }
extern "C" fn llvm_lyte_acoshf(x: f32) -> f32 { x.acosh() }
extern "C" fn llvm_lyte_atanhf(x: f32) -> f32 { x.atanh() }
extern "C" fn llvm_lyte_lnf(x: f32) -> f32 { x.ln() }
extern "C" fn llvm_lyte_expf(x: f32) -> f32 { x.exp() }
extern "C" fn llvm_lyte_exp2f(x: f32) -> f32 { x.exp2() }
extern "C" fn llvm_lyte_log10f(x: f32) -> f32 { x.log10() }
extern "C" fn llvm_lyte_log2f(x: f32) -> f32 { x.log2() }
extern "C" fn llvm_lyte_sqrtf(x: f32) -> f32 { x.sqrt() }
extern "C" fn llvm_lyte_absf(x: f32) -> f32 { x.abs() }
extern "C" fn llvm_lyte_floorf(x: f32) -> f32 { x.floor() }
extern "C" fn llvm_lyte_ceilf(x: f32) -> f32 { x.ceil() }
// f64 unary
extern "C" fn llvm_lyte_sind(x: f64) -> f64 { x.sin() }
extern "C" fn llvm_lyte_cosd(x: f64) -> f64 { x.cos() }
extern "C" fn llvm_lyte_tand(x: f64) -> f64 { x.tan() }
extern "C" fn llvm_lyte_asind(x: f64) -> f64 { x.asin() }
extern "C" fn llvm_lyte_acosd(x: f64) -> f64 { x.acos() }
extern "C" fn llvm_lyte_atand(x: f64) -> f64 { x.atan() }
extern "C" fn llvm_lyte_sinhd(x: f64) -> f64 { x.sinh() }
extern "C" fn llvm_lyte_coshd(x: f64) -> f64 { x.cosh() }
extern "C" fn llvm_lyte_tanhd(x: f64) -> f64 { x.tanh() }
extern "C" fn llvm_lyte_asinhd(x: f64) -> f64 { x.asinh() }
extern "C" fn llvm_lyte_acoshd(x: f64) -> f64 { x.acosh() }
extern "C" fn llvm_lyte_atanhd(x: f64) -> f64 { x.atanh() }
extern "C" fn llvm_lyte_lnd(x: f64) -> f64 { x.ln() }
extern "C" fn llvm_lyte_expd(x: f64) -> f64 { x.exp() }
extern "C" fn llvm_lyte_exp2d(x: f64) -> f64 { x.exp2() }
extern "C" fn llvm_lyte_log10d(x: f64) -> f64 { x.log10() }
extern "C" fn llvm_lyte_log2d(x: f64) -> f64 { x.log2() }
extern "C" fn llvm_lyte_sqrtd(x: f64) -> f64 { x.sqrt() }
extern "C" fn llvm_lyte_absd(x: f64) -> f64 { x.abs() }
extern "C" fn llvm_lyte_floord(x: f64) -> f64 { x.floor() }
extern "C" fn llvm_lyte_ceild(x: f64) -> f64 { x.ceil() }
// predicates
extern "C" fn llvm_lyte_isinff(x: f32) -> i32 { x.is_infinite() as i32 }
extern "C" fn llvm_lyte_isinfd(x: f64) -> i32 { x.is_infinite() as i32 }
extern "C" fn llvm_lyte_isnanf(x: f32) -> i32 { x.is_nan() as i32 }
extern "C" fn llvm_lyte_isnand(x: f64) -> i32 { x.is_nan() as i32 }
// binary f32
extern "C" fn llvm_lyte_powf(x: f32, y: f32) -> f32 { x.powf(y) }
extern "C" fn llvm_lyte_atan2f(y: f32, x: f32) -> f32 { y.atan2(x) }
extern "C" fn llvm_lyte_minf(x: f32, y: f32) -> f32 { x.min(y) }
extern "C" fn llvm_lyte_maxf(x: f32, y: f32) -> f32 { x.max(y) }
// binary f64
extern "C" fn llvm_lyte_powd(x: f64, y: f64) -> f64 { x.powf(y) }
extern "C" fn llvm_lyte_atan2d(y: f64, x: f64) -> f64 { y.atan2(x) }
extern "C" fn llvm_lyte_mind(x: f64, y: f64) -> f64 { x.min(y) }
extern "C" fn llvm_lyte_maxd(x: f64, y: f64) -> f64 { x.max(y) }
...
fn compile_and_run_with_context(
    ...
    state.module.verify().map_err(|e| format!("LLVM module verification failed: {}", e))?;
...
impl<'ctx> LLVMJITState<'ctx> {
    ...
    fn i64_ty(&self) -> inkwell::types::IntType<'ctx> { self.context.i64_type() }
    fn f32_ty(&self) -> inkwell::types::FloatType<'ctx> { self.context.f32_type() }
    fn f64_ty(&self) -> inkwell::types::FloatType<'ctx> { self.context.f64_type() }
    ...
    fn get_or_declare_extern(&mut self, sym: &str, fn_type: FunctionType<'ctx>, addr: usize) -> FunctionValue<'ctx> {
        if let Some(f) = self.module.get_function(sym) {
            f
        } else {
            let f = self.module.add_function(sym, fn_type, Some(Linkage::External));
    ...
    fn compile_function(
        ...
        for (i, cv) in decl.closure_vars.iter().enumerate() {
            ...
            let alloca = self.builder.build_alloca(self.ptr_ty(), &cv.name.to_string()).unwrap();
...
impl<'a, 'ctx> FunctionTranslator<'a, 'ctx> {
    fn ctx(&self) -> &'ctx Context { self.state.context }
    fn builder(&self) -> &Builder<'ctx> { &self.state.builder }
    fn module(&self) -> &Module<'ctx> { &self.state.module }

    fn ptr_ty(&self) -> inkwell::types::PointerType<'ctx> {
        self.ctx().ptr_type(AddressSpace::default())
    }
    fn i8_ty(&self) -> inkwell::types::IntType<'ctx> { self.ctx().i8_type() }
    fn i32_ty(&self) -> inkwell::types::IntType<'ctx> { self.ctx().i32_type() }
    fn i64_ty(&self) -> inkwell::types::IntType<'ctx> { self.ctx().i64_type() }
    ...
    fn coerce_to_type(&self, val: BasicValueEnum<'ctx>, expected: BasicTypeEnum<'ctx>) -> BasicValueEnum<'ctx> {
        ...
        if val.is_int_value() && expected.is_int_type() {
            ...
            if iv.get_type().get_bit_width() < et.get_bit_width() {
                return self.builder().build_int_z_extend(iv, et, "zext").unwrap().into();
            }
            if iv.get_type().get_bit_width() > et.get_bit_width() {
                return self.builder().build_int_truncate(iv, et, "trunc").unwrap().into();
            }
        }
        val
    }
    ...
    fn entry_array_alloca(&self, elem_ty: inkwell::types::IntType<'ctx>, size: u64, name: &str) -> PointerValue<'ctx> {
        let entry_bb = self.function.get_first_basic_block().unwrap();
        let current_bb = self.builder().get_insert_block().unwrap();
        if let Some(first_inst) = entry_bb.get_first_instruction() {
            self.builder().position_before(&first_inst);
    ...
    fn emit_cancel_check(&mut self) {
        ...
        let abort_ty = self.ctx().void_type().fn_type(
            &[self.ptr_ty().into()],
            false,
        );
        let abort_fn = self.state.get_or_declare_extern("__llvm_lyte_abort", abort_ty, llvm_lyte_abort as usize);
        self.builder()
    ...
    fn gen_eq(
        ...
        if ty.is_ptr() {
            ...
            let memcmp_fn = self.state.get_or_declare_extern("memcmp", memcmp_ty, libc::memcmp as usize);
            let size_val = self.i64_ty().const_int(size, false);
    ...
    fn match_single_var_assign(arena: &ExprArena, expr_id: ExprID) -> Option<(Name, ExprID)> {
        ...
        let inner = if let Expr::Block(stmts) = expr {
            if stmts.len() == 1 { &arena.exprs[stmts[0]] } else { return None; }
        } else {
            expr
        };
    ...
    fn compute_field_ptr(
        ...
        if let crate::Type::Name(struct_name, type_args) = &*lhs_ty {
            ...
            if let crate::Decl::Struct(s) = &struct_decl[0] {
                let inst: crate::Instance = s.typevars.iter()
                    .zip(type_args.iter())
    ...
    fn compute_array_elem_ptr(
        ...
        let elem_size = self.i64_ty().const_int(elem_ty.size(self.decls) as u64, false);
        // Extend idx to i64.
        let idx_i64 = self.builder()
            .build_int_z_extend(idx_val, self.i64_ty(), "idx64")
            .unwrap();
        let byte_off = self.builder()
    ...
    fn translate_expr(&mut self, expr: ExprID, decl: &FuncDecl) -> BasicValueEnum<'ctx> {
        match &decl.arena[expr] {
            ...
            Expr::ArrayLiteral(elements) => {
                ...
                let ty = decl.types[expr];
                let elem_values: Vec<BasicValueEnum<'ctx>> = elements.iter()
            ...
            Expr::Block(exprs) => {
                ...
                if exprs.is_empty() {
                    ...
                    for e in &exprs {
                        if self.is_block_terminated() { break; }
            ...
            Expr::Tuple(elements) => {
                let elements = elements.clone();
                let ty = decl.types[expr];
                let elem_vals: Vec<BasicValueEnum<'ctx>> = elements.iter()
                    .map(|e| self.translate_expr(*e, decl))
                    .collect();
                if let crate::Type::Tuple(elem_types) = &*ty {
                    let total_size: u64 = elem_types.iter()
                        .map(|t| t.size(self.decls) as u64)
                        .sum();
            ...
            _ => {
                panic!("LLVM JIT: unimplemented expression: {:?}", &decl.arena[expr])
            }
        }
    }

    fn translate_unop(&mut self, op: Unop, arg_id: ExprID, decl: &FuncDecl) -> BasicValueEnum<'ctx> {
    ...
    fn translate_binop(
        ...
        match op {
            Binop::Plus => {
                ...
                if is_float {
                    self.builder().build_float_add(lhs.into_float_value(), rhs.into_float_value(), "fadd").unwrap().into()
                } else {
                    self.builder().build_int_add(lhs.into_int_value(), rhs.into_int_value(), "iadd").unwrap().into()
                }
            }
            Binop::Minus => {
                let t = decl.types[lhs_id];
                ...
                let rhs = self.translate_expr(rhs_id, decl);
                if is_float {
                    self.builder().build_float_sub(lhs.into_float_value(), rhs.into_float_value(), "fsub").unwrap().into()
                } else {
                    self.builder().build_int_sub(lhs.into_int_value(), rhs.into_int_value(), "isub").unwrap().into()
                }
            }
            Binop::Mult => {
                let t = decl.types[lhs_id];
                ...
                if matches!(*t, crate::Type::Float32 | crate::Type::Float64) {
                    self.builder().build_float_mul(lhs.into_float_value(), rhs.into_float_value(), "fmul").unwrap().into()
                } else {
                    self.builder().build_int_mul(lhs.into_int_value(), rhs.into_int_value(), "imul").unwrap().into()
                }
            }
            Binop::Div => {
                let t = decl.types[lhs_id];
                ...
                match *t {
                    crate::Type::Float32 | crate::Type::Float64 =>
                        self.builder().build_float_div(lhs.into_float_value(), rhs.into_float_value(), "fdiv").unwrap().into(),
                    crate::Type::Int32 | crate::Type::Int8 =>
                        self.builder().build_int_signed_div(lhs.into_int_value(), rhs.into_int_value(), "sdiv").unwrap().into(),
                    _ =>
                        self.builder().build_int_unsigned_div(lhs.into_int_value(), rhs.into_int_value(), "udiv").unwrap().into(),
                }
            }
            Binop::Mod => {
                let t = decl.types[lhs_id];
                ...
                match *t {
                    crate::Type::Int32 | crate::Type::Int8 =>
                        self.builder().build_int_signed_rem(lhs.into_int_value(), rhs.into_int_value(), "srem").unwrap().into(),
                    _ =>
                        self.builder().build_int_unsigned_rem(lhs.into_int_value(), rhs.into_int_value(), "urem").unwrap().into(),
                }
            }
            Binop::Assign => {
            ...
            Binop::Less => {
                ...
                match *t {
                    crate::Type::Float32 | crate::Type::Float64 =>
                        self.builder().build_float_compare(FloatPredicate::OLT, lhs.into_float_value(), rhs.into_float_value(), "flt").unwrap().into(),
                    crate::Type::Int32 | crate::Type::Int8 =>
                        self.builder().build_int_compare(IntPredicate::SLT, lhs.into_int_value(), rhs.into_int_value(), "slt").unwrap().into(),
                    _ =>
                        self.builder().build_int_compare(IntPredicate::ULT, lhs.into_int_value(), rhs.into_int_value(), "ult").unwrap().into(),
                }
            }
            Binop::Greater => {
                let t = decl.types[lhs_id];
                ...
                match *t {
                    crate::Type::Float32 | crate::Type::Float64 =>
                        self.builder().build_float_compare(FloatPredicate::OGT, lhs.into_float_value(), rhs.into_float_value(), "fgt").unwrap().into(),
                    crate::Type::Int32 | crate::Type::Int8 =>
                        self.builder().build_int_compare(IntPredicate::SGT, lhs.into_int_value(), rhs.into_int_value(), "sgt").unwrap().into(),
                    _ =>
                        self.builder().build_int_compare(IntPredicate::UGT, lhs.into_int_value(), rhs.into_int_value(), "ugt").unwrap().into(),
                }
            }
            Binop::Leq => {
                let t = decl.types[lhs_id];
                ...
                match *t {
                    crate::Type::Float32 | crate::Type::Float64 =>
                        self.builder().build_float_compare(FloatPredicate::OLE, lhs.into_float_value(), rhs.into_float_value(), "fle").unwrap().into(),
                    crate::Type::Int32 | crate::Type::Int8 =>
                        self.builder().build_int_compare(IntPredicate::SLE, lhs.into_int_value(), rhs.into_int_value(), "sle").unwrap().into(),
                    _ =>
                        self.builder().build_int_compare(IntPredicate::ULE, lhs.into_int_value(), rhs.into_int_value(), "ule").unwrap().into(),
                }
            }
            Binop::Geq => {
                let t = decl.types[lhs_id];
                ...
                match *t {
                    crate::Type::Float32 | crate::Type::Float64 =>
                        self.builder().build_float_compare(FloatPredicate::OGE, lhs.into_float_value(), rhs.into_float_value(), "fge").unwrap().into(),
                    crate::Type::Int32 | crate::Type::Int8 =>
                        self.builder().build_int_compare(IntPredicate::SGE, lhs.into_int_value(), rhs.into_int_value(), "sge").unwrap().into(),
                    _ =>
                        self.builder().build_int_compare(IntPredicate::UGE, lhs.into_int_value(), rhs.into_int_value(), "uge").unwrap().into(),
                }
            }
            Binop::And => {
    ...
    fn build_fma(
        ...
        let fma_intrinsic = inkwell::intrinsics::Intrinsic::find(fma_name)
            .expect("llvm.fma intrinsic not found");
    ...
    fn translate_cast(
        ...
        match (&*src_ty, &*dst_ty) {
            (crate::Type::Int32, crate::Type::Float32) =>
                self.builder().build_signed_int_to_float(val.into_int_value(), self.state.f32_ty(), "i2f32").unwrap().into(),
            (crate::Type::UInt32, crate::Type::Float32) =>
                self.builder().build_unsigned_int_to_float(val.into_int_value(), self.state.f32_ty(), "u2f32").unwrap().into(),
            (crate::Type::Float32, crate::Type::Int32) =>
                self.builder().build_float_to_signed_int(val.into_float_value(), self.i32_ty(), "f2i32").unwrap().into(),
            (crate::Type::Float32, crate::Type::UInt32) =>
                self.builder().build_float_to_unsigned_int(val.into_float_value(), self.i32_ty(), "f2u32").unwrap().into(),
            (crate::Type::Int32, crate::Type::Float64) =>
                self.builder().build_signed_int_to_float(val.into_int_value(), self.state.f64_ty(), "i2f64").unwrap().into(),
            (crate::Type::UInt32, crate::Type::Float64) =>
                self.builder().build_unsigned_int_to_float(val.into_int_value(), self.state.f64_ty(), "u2f64").unwrap().into(),
            (crate::Type::Float64, crate::Type::Int32) =>
                self.builder().build_float_to_signed_int(val.into_float_value(), self.i32_ty(), "f642i").unwrap().into(),
            (crate::Type::Float64, crate::Type::UInt32) =>
                self.builder().build_float_to_unsigned_int(val.into_float_value(), self.i32_ty(), "f642u").unwrap().into(),
            (crate::Type::Float32, crate::Type::Float64) =>
                self.builder().build_float_cast(val.into_float_value(), self.state.f64_ty(), "fpromote").unwrap().into(),
            (crate::Type::Float64, crate::Type::Float32) =>
                self.builder().build_float_cast(val.into_float_value(), self.state.f32_ty(), "fdemote").unwrap().into(),
            (crate::Type::Int8, crate::Type::Int32) =>
                self.builder().build_int_s_extend(val.into_int_value(), self.i32_ty(), "sext").unwrap().into(),
            (crate::Type::Int32, crate::Type::Int8) =>
                self.builder().build_int_truncate(val.into_int_value(), self.i8_ty(), "trunc").unwrap().into(),
            _ => val,
        }
    }
    ...
    fn translate_call(
        ...
        if let crate::Type::Func(from, to) = *fn_type {
            ...
            let result_val: BasicValueEnum<'ctx> = if let Some((sym, fn_ty, addr)) = math_sym {
                ...
                let call = self.builder().build_call(callee, &args, "math_call").unwrap();
                if let Some(slot) = output_slot {
                    slot.into()
                } else {
                ...
                if let Some(slot) = output_slot {
                    ...
                    call.try_as_basic_value().left().unwrap_or_else(|| self.zero_i32())
                }
            } else {
                ...
                for (i, arg_id) in arg_ids.iter().enumerate() {
                    ...
                    if i < param_types.len() && is_slice(param_types[i]) {
                        let wrapped = self.wrap_as_slice(arg_val.into_pointer_value(), decl.types[*arg_id]);
    ...
    fn math_sym_suffix(&self, name: &Name) -> &'static str {
        let pairs: &[(&str, &str)] = &[
            ("sin$f32", "sinf"), ("cos$f32", "cosf"), ("tan$f32", "tanf"),
            ("asin$f32", "asinf"), ("acos$f32", "acosf"), ("atan$f32", "atanf"),
            ("sinh$f32", "sinhf"), ("cosh$f32", "coshf"), ("tanh$f32", "tanhf"),
            ("asinh$f32", "asinhf"), ("acosh$f32", "acoshf"), ("atanh$f32", "atanhf"),
            ("ln$f32", "lnf"), ("exp$f32", "expf"), ("exp2$f32", "exp2f"),
            ("log10$f32", "log10f"), ("log2$f32", "log2f"), ("sqrt$f32", "sqrtf"),
            ("abs$f32", "absf"), ("floor$f32", "floorf"), ("ceil$f32", "ceilf"),
            ("sin$f64", "sind"), ("cos$f64", "cosd"), ("tan$f64", "tand"),
            ("asin$f64", "asind"), ("acos$f64", "acosd"), ("atan$f64", "atand"),
            ("sinh$f64", "sinhd"), ("cosh$f64", "coshd"), ("tanh$f64", "tanhd"),
            ("asinh$f64", "asinhd"), ("acosh$f64", "acoshd"), ("atanh$f64", "atanhd"),
            ("ln$f64", "lnd"), ("exp$f64", "expd"), ("exp2$f64", "exp2d"),
            ("log10$f64", "log10d"), ("log2$f64", "log2d"), ("sqrt$f64", "sqrtd"),
            ("abs$f64", "absd"), ("floor$f64", "floord"), ("ceil$f64", "ceild"),
            ("isinf$f32", "isinff"), ("isinf$f64", "isinfd"),
            ("isnan$f32", "isnanf"), ("isnan$f64", "isnand"),
            ("pow$f32$f32", "powf"), ("atan2$f32$f32", "atan2f"),
            ("min$f32$f32", "minf"), ("max$f32$f32", "maxf"),
            ("pow$f64$f64", "powd"), ("atan2$f64$f64", "atan2d"),
            ("min$f64$f64", "mind"), ("max$f64$f64", "maxd"),
        ];
        for &(n, s) in pairs {
            if **name == *n { return s; }
        }
    ...
    fn translate_func_ref(&mut self, name: &Name, ty: &crate::Type) -> BasicValueEnum<'ctx> {
        ...
        if *name == Name::str("assert") {
            let fn_ty = self.ctx().void_type().fn_type(&[self.i8_ty().into()], false);
            let f = self.state.get_or_declare_extern("__llvm_lyte_assert", fn_ty, llvm_lyte_assert as usize);
            let ptr = f.as_global_value().as_pointer_value();
            return self.make_fat_ptr(ptr, None);
        }
        if *name == Name::str("print") {
            let fn_ty = self.ctx().void_type().fn_type(&[self.i32_ty().into()], false);
            let f = self.state.get_or_declare_extern("__llvm_lyte_print", fn_ty, llvm_lyte_print_i32 as usize);
            let ptr = f.as_global_value().as_pointer_value();
            return self.make_fat_ptr(ptr, None);
        }
        if *name == Name::str("putc") {
            let fn_ty = self.ctx().void_type().fn_type(&[self.i32_ty().into()], false);
            let f = self.state.get_or_declare_extern("__llvm_lyte_putc", fn_ty, llvm_lyte_putc as usize);
            let ptr = f.as_global_value().as_pointer_value();
            return self.make_fat_ptr(ptr, None);
        }
        ...
        if let crate::Type::Func(dom, rng) = ty {
            ...
            let f = if let Some(existing) = self.module().get_function(&**name) {
                ...
                self.module().add_function(&**name, full_fn_ty, Some(Linkage::External))
            };
    ...
    fn make_fat_ptr(
        ...
        let clos_val: PointerValue<'ctx> = closure.unwrap_or_else(|| {
    ...
    fn translate_lambda(
        ...
        if let crate::Type::Func(dom, rng) = *lambda_ty {
            if let crate::Type::Tuple(param_types) = &*dom {
                ...
                let lambda_params: Vec<Param> = params.iter()
                ...
                let closure_vars: Vec<ClosureVar> = free_vars.iter()
                    .map(|(n, ty)| ClosureVar { name: Name::new(n.clone()), ty: *ty })
                    .collect();
                ...
                let lambda_fn = if let Some(f) = self.module().get_function(&*lambda_name) {
                    ...
                    self.module().add_function(&*lambda_name, full_fn_ty, Some(Linkage::External))
                };
...
fn collect_free_var_names_llvm(
    ...
    collect_free_vars_rec_llvm(body, arena, exclude, local_vars, types, &mut result, &mut seen);
    result
}
...
fn collect_free_vars_rec_llvm(
    ...
    match &arena[expr] {
        ...
        Expr::Call(fn_id, args) => {
            ...
            for a in args { collect_free_vars_rec_llvm(*a, arena, exclude, local_vars, types, result, seen); }
        }
        ...
        Expr::Unop(_, arg) => collect_free_vars_rec_llvm(*arg, arena, exclude, local_vars, types, result, seen),
        Expr::Let(_, init, _) => collect_free_vars_rec_llvm(*init, arena, exclude, local_vars, types, result, seen),
        Expr::Var(_, init, _) => {
            if let Some(i) = init { collect_free_vars_rec_llvm(*i, arena, exclude, local_vars, types, result, seen); }
        }
        Expr::If(c, t, e) => {
            ...
            if let Some(e) = e { collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen); }
        }
        Expr::While(c, b) => {
            collect_free_vars_rec_llvm(*c, arena, exclude, local_vars, types, result, seen);
        ...
        Expr::Block(exprs) => {
            for e in exprs { collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen); }
        }
        Expr::Return(e) => collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen),
        Expr::Field(e, _) => collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen),
        Expr::ArrayIndex(a, i) => {
        ...
        Expr::ArrayLiteral(elems) => {
            for e in elems { collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen); }
        }
        Expr::Tuple(elems) => {
            for e in elems { collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen); }
        }
        Expr::AsTy(e, _) => collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen),
        Expr::Arena(e) => collect_free_vars_rec_llvm(*e, arena, exclude, local_vars, types, result, seen),
        Expr::Array(t, s) => {
            collect_free_vars_rec_llvm(*t, arena, exclude, local_vars, types, result, seen);
        ...
        Expr::Lambda { params, body } => {
            ...
            for p in params { inner.insert(p.name.to_string()); }
